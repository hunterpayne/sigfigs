...
class DataRateSpec 
  ...
  it should "create values using UOM factories" in {
    ...
    GigabytesPerSecond(1).toGigabytesPerSecond  should be(SDD(1))
    TerabytesPerSecond(1).toTerabytesPerSecond  should be(SDD(1))
    PetabytesPerSecond(1).toPetabytesPerSecond  should be(SDD(1))
    ExabytesPerSecond(1).toExabytesPerSecond    should be(SDD(1))
    ZettabytesPerSecond(1).toZettabytesPerSecond should be(SDD(1))
    YottabytesPerSecond(1).toYottabytesPerSecond should be(SDD(1))

    KibibytesPerSecond(1).toKibibytesPerSecond should be(SDD(1))
    MebibytesPerSecond(1).toMebibytesPerSecond should be(SDD(1))
    GibibytesPerSecond(1).toGibibytesPerSecond should be(SDD(1))
    TebibytesPerSecond(1).toTebibytesPerSecond should be(SDD(1))
    PebibytesPerSecond(1).toPebibytesPerSecond should be(SDD(1))
    ExbibytesPerSecond(1).toExbibytesPerSecond should be(SDD(1))
    ZebibytesPerSecond(1).toZebibytesPerSecond should be(SDD(1))
    YobibytesPerSecond(1).toYobibytesPerSecond should be(SDD(1))

    BitsPerSecond(1).toBitsPerSecond should be(SDD(1))

    KilobitsPerSecond(1).toKilobitsPerSecond   should be(SDD(1))
    MegabitsPerSecond(1).toMegabitsPerSecond   should be(SDD(1))
    GigabitsPerSecond(1).toGigabitsPerSecond   should be(SDD(1))
    TerabitsPerSecond(1).toTerabitsPerSecond   should be(SDD(1))
    PetabitsPerSecond(1).toPetabitsPerSecond   should be(SDD(1))
    ExabitsPerSecond(1).toExabitsPerSecond     should be(SDD(1))
    ZettabitsPerSecond(1).toZettabitsPerSecond should be(SDD(1))
    YottabitsPerSecond(1).toYottabitsPerSecond should be(SDD(1))

    KibibitsPerSecond(1).toKibibitsPerSecond should be(SDD(1))
    MebibitsPerSecond(1).toMebibitsPerSecond should be(SDD(1))
    GibibitsPerSecond(1).toGibibitsPerSecond should be(SDD(1))
    TebibitsPerSecond(1).toTebibitsPerSecond should be(SDD(1))
    PebibitsPerSecond(1).toPebibitsPerSecond should be(SDD(1))
    ExbibitsPerSecond(1).toExbibitsPerSecond should be(SDD(1))
    ZebibitsPerSecond(1).toZebibitsPerSecond should be(SDD(1))
    YobibitsPerSecond(1).toYobibitsPerSecond should be(SDD(1))
  }
  ...
  it should "properly convert to all supported Units of Measure" in {
    ...
    x.toBytesPerSecond should be(SDD(1))

    x.toKilobytesPerSecond should be(SDD(0.001))
    x.toMegabytesPerSecond should be(SDD(0.000001))
    x.toGigabytesPerSecond should be(SDD(0.000000001))
    x.toTerabytesPerSecond should be(SDD(0.000000000001))
    x.toPetabytesPerSecond should be(SDD(0.000000000000001))
    x.toExabytesPerSecond should be(SDD(0.000000000000000001))
    x.toZettabytesPerSecond should be(SDD(0.000000000000000000001))
    x.toYottabytesPerSecond.v should beApproximately(0.000000000000000000000001)

    x.toKibibytesPerSecond should be(SDD(1.0 / 1024.0, 1))
    x.toMebibytesPerSecond should be(SDD(1.0 / scala.math.pow(2, 20), 1))
    x.toGibibytesPerSecond should be(SDD(1.0 / scala.math.pow(2, 30), 1))
    x.toTebibytesPerSecond should be(SDD(1.0 / scala.math.pow(2, 40), 1))
    x.toPebibytesPerSecond should be(SDD(1.0 / scala.math.pow(2, 50), 1))
    x.toExbibytesPerSecond should be(SDD(1.0 / scala.math.pow(2, 60), 1))
    x.toZebibytesPerSecond should be(SDD(1.0 / scala.math.pow(2, 70), 1))
    x.toYobibytesPerSecond should be(SDD(1.0 / scala.math.pow(2, 80), 1))

    x.toBitsPerSecond should be(SDD(8.0))
    x.toKilobitsPerSecond should be(SDD(0.008))
    x.toMegabitsPerSecond should be(SDD(0.000008))
    x.toGigabitsPerSecond should be(SDD(0.000000008))
    x.toTerabitsPerSecond should be(SDD(0.000000000008))
    x.toPetabitsPerSecond should be(SDD(0.000000000000008))
    x.toExabitsPerSecond.v should beApproximately(0.000000000000000008)
    x.toZettabitsPerSecond.v should beApproximately(0.000000000000000000008)
    x.toYottabitsPerSecond.v should beApproximately(0.000000000000000000000008)

    x.toKibibitsPerSecond should be(SDD(8.0 / 1024.0, 1))
    x.toMebibitsPerSecond should be(SDD(8.0 / scala.math.pow(2, 20), 1))
    x.toGibibitsPerSecond should be(SDD(8.0 / scala.math.pow(2, 30), 1))
    x.toTebibitsPerSecond should be(SDD(8.0 / scala.math.pow(2, 40), 1))
    x.toPebibitsPerSecond should be(SDD(8.0 / scala.math.pow(2, 50), 1))
    x.toExbibitsPerSecond should be(SDD(8.0 / scala.math.pow(2, 60), 1))
    x.toZebibitsPerSecond should be(SDD(8.0 / scala.math.pow(2, 70), 1))
    x.toYobibitsPerSecond should be(SDD(8.0 / scala.math.pow(2, 80), 1))
  }
  ...
  it should "return a dimensionless ratio when divided by a DataRate" in {
    BytesPerSecond(10) / BytesPerSecond(4) should be(SDD(2.5, 1))
  }
  ...
  it should "provide Numeric support" in {
    ...
    dr.sum should be(BytesPerSecond(SDD(101, 1)))
  }
}
